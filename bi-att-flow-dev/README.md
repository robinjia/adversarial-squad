These files contain code for the BiDAF model.
This directory was originally downloaded from 
[codalab](https://worksheets.codalab.org/bundles/0x362ff69b5d47429ba2fcff225130f298/).
...
We also added a web server that ran the BiDAF model (for debugging).
The original code is also released [on github](https://github.com/allenai/bi-att-flow)
